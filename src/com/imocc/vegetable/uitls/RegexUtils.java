 ...
 * @class com.easyway.mdhdatasyncc.utils.RegexUtils
 * @time 2019/1/7 15:09
 * @description 请填写描述
 */
...
public class RegexUtils {
     ...
     * @return 验证成功返回true，验证失败返回false
     */
    public static boolean checkIpPort(String ipAddress) {
        String ip_ip = "(25[0-5]|2[0-4]\\d|1\\d\\d|\\d\\d|\\d)";
        String ip_ipdot = ip_ip + "\\.";
        String ip_port = "(:(\\d\\d\\d\\d|\\d\\d\\d|\\d\\d|\\d))?";
        String regex = "https?://" + ip_ipdot + ip_ipdot + ip_ipdot + ip_ip + ip_port + "$";
        return Pattern.matches(regex, ipAddress);
    }
